...
const APP_BE_URL = "https://my-projects-backend.onrender.com";
...
router.get("/pay", async function (req, res, next) {
  ...
  let merchantTransactionId = uniqid()+Date.now()+"56745";
  ...
  axios
    ...
    .catch(function (error) {
      if (error.response) {
        ...
        console.error("Headers:", error.response.headers); // might contain rate limit info
